...
export default function Example() {
  ...
  const links = [
    ...
    { link: t("links.vendors"), path: "/vendors" },
        ...
        >
          <MegaMenu
            ...
            className={`duration-200 ${
              megaMenuOpen
                ? "visible translate-y-0  opacity-100 hover:visible hover:translate-y-0  hover:opacity-100"
                : "invisible delay-200  translate-y-16 opacity-0"
            }`}
          />
          ...
          <PopoverGroup className="hidden lg:flex lg:gap-x-12">
            <NavLink
              to="/"
              className="text-base font-medium font-roboto hover:text-[#ffae00] duration-200 leading-6 text-gray-900"
            >
              {t("links.home")}
            </NavLink>
            <div>
              <NavLink
                ...
                onMouseLeave={() => setMegaMenuOpen(false)}
                to="/shop"
                className="text-base inline-block font-medium font-roboto hover:text-[#ffae00] duration-200 leading-6 text-gray-900"
              >
                {t("links.shop")}
              </NavLink>
            </div>
